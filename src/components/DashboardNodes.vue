<template>
  <v-container style="padding: 0">
    <v-card class="mx-auto dashboard-nodes" rounded="4" color="background">
      <v-row>
        <v-col cols="12" md="3">
          <div class="block">
          ...
          <div class="block">
            ...
            <v-row align="center" style="margin-top: 2px">
              ...
              <v-col cols="12" md="9" style="padding-left: 0">
                ...
                <v-progress-linear height="10" color="#2115E5" striped :value="value"></v-progress-linear>
              </v-col>
            </v-row>
          </div>
        </v-col>
            ...
            tooltip: {
              ...
              formatter: function (params) {
                ...
                let str =
                  ...
                  '</span>' +
                  '<br/>' +
                  '<div style="color: #868E9E;max-width:30rem;text-overflow:ellipsis;overflow:hidden;-webkit-line-clamp:2;">' +
                  `${params.data.nodeDesc}` +
                  '</div>' +
                  '<i data-v-8e64a00a aria-hidden="true" style="font-size:16px;" class="v-icon notranslate mdi mdi-map-marker theme--light"></i>' +
                  '<span style="color: #868E9E;margin-left:8px;">' +
                  `${params.data.name}` +
                  '</span>';
